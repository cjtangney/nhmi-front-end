          ...
          <div className='columns'>
            <div className='column col-12'>
              <CardImgLeft imgSrc={Image1} className='img-responsive' cardBody={
                <div>
                  <h2>Quilt Room</h2>
                  <p className='text-large'>The Quilt Room is located upstairs in the original section of Farmhouse. Filled with wonderful country charm, this room forms the perfect family suite when booked with the adjacent Timber Room. Please note, the Quilt Room has low ceilings.</p>
                  <h3>Amenities</h3>
