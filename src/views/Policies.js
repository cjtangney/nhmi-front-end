...
class Policies extends React.Component {
  accordionActiveToggle = (event) => {
    event.target.classList.toggle('active');
  }
  accordionInactive = (event) => {
  ...
  render() {
    return (
      <div>
        <div className='container grid-xl' id='policies-container'>
              ...
              <p>If you have questions pertaining to specific policies, select one of the sections below to learn more. If you still have inquiries, <strong><a href='mailto:info@nhmountaininn.com'>send us an email</a></strong> or give us a call at <strong className='text-primary'>1-888-797-2899</strong>.</p>
      			</div>
          </div>
          <div className='columns'>
            <div className='column col-8 col-mx-auto'>
              <div className='accordion' id='reservation-accordion'>
                <input type='checkbox' id='reservation-policy-item' name='accordion-checkbox' hidden />
                <label className='accordion-header text-center' htmlFor='reservation-policy-item'>
                  <div className='divider text-center hvr-overline-from-center' data-content='Reservation Policy' onMouseOver={e=>(this.accordionActiveToggle(e))} onMouseLeave={e=>(this.accordionInactive(e))} onClick={e=>(this.accordionOpen(e))}></div>
                </label>
              ...
              <div className='accordion' id='cancellation-accordion'>
                <input type='checkbox' id='cancellation-policy-item' name='accordion-checkbox' hidden />
                <label className='accordion-header text-center' htmlFor='cancellation-policy-item'>
                  <div className='divider text-center hvr-overline-from-center' data-content='Cancellation Policy' onMouseOver={e=>(this.accordionActiveToggle(e))} onMouseLeave={e=>(this.accordionInactive(e))} onClick={e=>(this.accordionOpen(e))}></div>
                </label>
                <div className='accordion-body'>
              ...
              <div className='accordion' id='gift-cert-accordion'>
                <input type='checkbox' id='gift-cert-policy-item' name='accordion-checkbox' hidden />
                <label className='accordion-header text-center' htmlFor='gift-cert-policy-item'>
                  <div className='divider text-center hvr-overline-from-center' data-content='Gift Certificate Policy' onMouseOver={e=>(this.accordionActiveToggle(e))} onMouseLeave={e=>(this.accordionInactive(e))} onClick={e=>(this.accordionOpen(e))}></div>
                </label>
                <div className='accordion-body'>
              ...
              <div className='accordion' id='pet-accordion'>
                <input type='checkbox' id='pet-policy-item' name='accordion-checkbox' hidden />
                <label className='accordion-header text-center' htmlFor='pet-policy-item'>
                  <div className='divider text-center hvr-overline-from-center' data-content='Pet Policy' onMouseOver={e=>(this.accordionActiveToggle(e))} onMouseLeave={e=>(this.accordionInactive(e))} onClick={e=>(this.accordionOpen(e))}></div>
                </label>
                <div className='accordion-body'>
